...
import {
  normalizeUrl,
  validateImageUrl,
} from "./agent-editor-components/utils";
import { IBubbleMenu, IFloatMenu, ITopToolbarItem } from "./types/type";
...
export const AGENT_TOOLBAR_CONFIG: ITopToolbarItem[][] = [
  ...
  // Headings
  [
    { icon: "type", title: "Font Size", type: "font-size" as const },
    {
      icon: "heading-1",
      title: "Heading 1",
  ...
  // Color & Highlight
  [
    { icon: "palette", title: "Text Color", type: "color-picker" as const },
    {
      icon: "highlighter",
      title: "Highlight",
...
export const NOTION_BUBBLE_FORMAT_MENU_TOOLBAR_CONFIG: IBubbleMenu[] = [
  {
    icon: "bold",
    action: (e) => e.chain().focus().toggleBold().run(),
