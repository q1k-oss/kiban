...
export const variantConfig: Record<ActionableToastVariant, VariantConfig> = {
  success: {
    ...
    progressColor: "linear-gradient(to right, transparent, #22c55e)",
  },
  error: {
    ...
    progressColor: "linear-gradient(to right, transparent, #ef4444)",
  },
  warning: {
    iconName: "circle-alert",
    iconSource: "lucide",
    ...
    progressColor: "linear-gradient(to right, transparent, #a3a634)",
  },
  info: {
    iconName: "info",
    iconSource: "lucide",
    ...
    progressColor: "linear-gradient(to right, transparent, #3b82f6)",
  },
};

export const resolveColors = (
  variant: ActionableToastVariant,
  overrides?: ToastColors,
): VariantConfig => {
  const base = variantConfig[variant];
  if (!overrides) return base;

  return Object.assign({}, base, Object.fromEntries(
