...
export default function SingleBlogHeader({ blogFlagName, excerpt, updatedAt, title, readTime, className, }) {
    const formattedDate = updatedAt ? formatDate(updatedAt) : null;
    return (_jsxs("div", { className: cn('relative w-full min-h-80 bg-cover bg-center bg-no-repeat  flex flex-col justify-end gap-10 md:gap-8', className), children: [_jsx(SingleBlogHeaderBackground, { className: "absolute inset-0 z-0 hidden md:block" }), _jsx("div", { className: "pointer-events-none absolute inset-x-0 bottom-0 h-40 z-0 bg-linear-to-b from-transparent to-black" }), (blogFlagName || readTime) && (_jsxs("div", { className: "flex items-center gap-4 z-10", children: [blogFlagName && (_jsx("span", { className: "px-2 py-1.5 text-primary-text bg-button-fill-3 rounded-sm font-medium text-xs", children: blogFlagName })), readTime && _jsx("span", { className: "text-sm", children: readTime })] })), title && (_jsx("h1", { className: "text-3xl lg:text-5xl font-semibold text-primary-text z-10", children: title })), excerpt && (_jsx("p", { className: "text-secondary-text font-light text-lg z-10", children: excerpt })), formattedDate && (_jsxs("p", { className: "text-secondary-text font-light z-10", children: ["Updated, ", formattedDate] })), _jsx("hr", { className: "border-border-3 z-10" })] }));
}
