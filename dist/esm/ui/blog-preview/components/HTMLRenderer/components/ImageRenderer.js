...
const ImageRenderer = ({ src, alt, config }) => {
    var _a, _b, _c, _d;
    ...
    if ((config === null || config === void 0 ? void 0 : config.wrapperClassName) || (config === null || config === void 0 ? void 0 : config.addCaption)) {
        return (_jsxs("figure", { className: cn('my-8', config === null || config === void 0 ? void 0 : config.wrapperClassName), children: [image, (config === null || config === void 0 ? void 0 : config.addCaption) && alt && (_jsx("figcaption", { className: cn('text-center italic text-[#666] mt-2 text-sm'), children: alt }))] }));
    }
