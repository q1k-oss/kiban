...
const ParagraphRenderer = ({ innerHtml, attrs, config, renderContent, }) => {
    ...
    if (hasBlockChild) {
        return (_jsx("div", { className: (config === null || config === void 0 ? void 0 : config.className) || '', style: inlineStyle, children: renderContent(innerHtml) }));
    }
    return _jsx("p", { className: (config === null || config === void 0 ? void 0 : config.className) || '', style: inlineStyle, children: renderContent(innerHtml) });
};
