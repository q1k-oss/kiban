...
export const KibanToastContent = ({ id, title, description, variant, duration = 5000, showProgress = true, colors, className, }) => {
    ...
    return (_jsx("div", { role: variant === "error" ? "alert" : "status", "aria-live": variant === "error" ? "assertive" : "polite", "aria-atomic": "true", className: cn("rounded-lg shadow-lg p-px w-[380px]", showProgress && "pb-0", className), style: { background: config.borderGradient }, children: _jsxs("div", { className: "relative rounded-lg overflow-hidden flex flex-col", style: { background: config.bgColor }, children: [_jsx("div", { className: "p-3 flex flex-col gap-2", children: _jsxs("div", { className: cn("flex gap-2", description ? "items-start" : "items-center"), children: [_jsx("span", { className: "shrink-0", style: { color: config.iconColor }, children: _jsx(AppIcon, { iconName: config.iconName, source: config.iconSource, size: 20, strokeWidth: 1.5 }) }), _jsxs("div", { className: "flex-1 min-w-0 flex flex-col gap-2", children: [_jsx("span", { className: "font-medium text-primary-text text-sm leading-tight", children: title }), description && (_jsx("span", { className: "text-tertiary-text text-xs font-normal", children: description }))] }), _jsx(Button, { variant: "ghost", onClick: () => toast.dismiss(id), className: "bg-transparent border-none text-tertiary-text cursor-pointer p-1 shrink-0 rounded-md", children: _jsx(AppIcon, { iconName: "x", size: 20, strokeWidth: 1.5 }) })] }) }), showProgress && _jsx(TimeBar, { progress: progress, color: config.progressColor })] }) }));
};
