...
const createToast = (variant) => {
    return (title, options) => {
        ...
        const id = toast.custom((toastId) => (_jsx(KibanToastContent, { id: toastId, title: title, description: options === null || options === void 0 ? void 0 : options.description, variant: variant, duration: duration })), {
