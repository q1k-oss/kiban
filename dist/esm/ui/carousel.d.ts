...
declare function CarouselIndicators({ count, current, onClick, }: {
    count: number;
    current: number;
    onClick: (index: number) => void;
}): import("react/jsx-runtime").JSX.Element;
export { type CarouselApi, Carousel, CarouselContent, CarouselItem, CarouselPrevious, CarouselNext, CarouselIndicators, type CarouselProps };
