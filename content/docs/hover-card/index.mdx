...
### Props
<AutoTypeTable path="./components/ui/hover-card.tsx" name="HoverCard" />
<AutoTypeTable path="./components/ui/hover-card.tsx" name="HoverCardTrigger" />
<AutoTypeTable path="./components/ui/hover-card.tsx" name="HoverCardContent" /> 