      ...
      <SidebarProvider defaultOpen={true} className="flex h-[500px]">
        ...
        <SidebarInset>
          ...
          <div className="flex-1 p-6">
            ...
            <p className="mb-2 text-sm">On mobile devices:</p>
            <ul className="list-disc pl-5 text-sm mb-4">
              <li>The sidebar is hidden by default</li>
              <li>Click the menu button in the header to open it as a sheet</li>
              <li>The sidebar automatically closes when you click outside or select an item</li>
            </ul>
            <p className="mb-2 text-sm">On desktop:</p>
            <ul className="list-disc pl-5 text-sm">
              <li>The sidebar is always visible</li>
              <li>You can toggle it using the button in the header</li>
            </ul>
          </div>
        </SidebarInset>
      </SidebarProvider>
